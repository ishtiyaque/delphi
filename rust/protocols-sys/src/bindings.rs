...
pub const Mode_InputConv: Mode = 0;
pub const Mode_Input: Mode = 1;
pub const Mode_Output: Mode = 2;
pub type Mode = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Metadata {
...
extern "C" {
    pub fn client_keygen(
        key_share: *mut *mut ::std::os::raw::c_char,
        key_share_len: *mut u64,
    ) -> ClientFHE;
}
extern "C" {
    pub fn server_keygen(key_share: *mut ::std::os::raw::c_char) -> ServerFHE;
}
extern "C" {
...
extern "C" {
    pub fn triples_preprocess(
        share: *const u64,
        encoder_c: *mut ::std::os::raw::c_void,
        encryptor_c: *mut ::std::os::raw::c_void,
        num_triples: ::std::os::raw::c_int,
        enc_size: *mut u64,
    ) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn conv_preprocess_noise(
        sfhe: *const ServerFHE,
        data: *const Metadata,
        secret_share: *const *const u64,
    ) -> *mut *mut ::std::os::raw::c_char;
}
extern "C" {
...
extern "C" {
    pub fn server_conv_online(
        ciphertext: *mut ::std::os::raw::c_char,
        masks: *mut *mut *mut *mut ::std::os::raw::c_char,
        sfhe: *const ServerFHE,
        data: *const Metadata,
        mode: Mode,
        enc_noise: *mut *mut ::std::os::raw::c_char,
        enc_result_size: *mut u64,
    ) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn server_fc_online(
        ...
        sfhe: *const ServerFHE,
        data: *const Metadata,
        enc_noise: *mut ::std::os::raw::c_char,
        enc_result_size: *mut u64,
    ) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn server_triples_online(
        client_a: *mut ::std::os::raw::c_char,
        client_b: *mut ::std::os::raw::c_char,
        a_share: *const u64,
        b_share: *const u64,
        r_share: *const u64,
        sfhe: *const ServerFHE,
...
extern "C" {
    pub fn client_conv_decrypt(
        enc_result: *mut ::std::os::raw::c_char,
        cfhe: *const ClientFHE,
        data: *const Metadata,
    ) -> *mut *mut u64;
}
...
extern "C" {
    pub fn client_triples_decrypt(
        a_share: *const u64,
        b_share: *const u64,
        client_share: *mut ::std::os::raw::c_char,
        cfhe: *const ClientFHE,
        num_triples: ::std::os::raw::c_int,
    ) -> *mut u64;
}
...
extern "C" {
    pub fn free_key_share(key_share: *mut ::std::os::raw::c_char);
}
extern "C" {
    pub fn client_conv_free(
        data: *const Metadata,
        ciphertext: *mut ::std::os::raw::c_char,
        result: *mut *mut u64,
        mode: Mode,
...
extern "C" {
    pub fn client_fc_free(ciphertext: *mut ::std::os::raw::c_char, result: *mut u64);
}
extern "C" {
...
extern "C" {
    pub fn triples_free(ciphertext: *mut ::std::os::raw::c_char);
}
